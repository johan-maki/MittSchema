    ...
    <AppLayout>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50/30">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-12">
          ...
          <section id="hur-fungerar-schemaläggningen" className="scroll-mt-32">
          ...
          <section id="begränsningssystem" className="scroll-mt-32 mb-12">
            <Card className="bg-white/80 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-2xl">
          ...
          {/* System Navigation */}
          <section id="navigera-i-systemet" className="scroll-mt-32 mb-12">
            <Card className="bg-white/80 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-2xl">
          ...
          <section id="schema-process" className="scroll-mt-32 mb-12">
            <Card className="bg-white/80 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-2xl">
          ...
          <section id="preferenser" className="scroll-mt-32 mb-12">
            <Card className="bg-white/80 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-2xl">
          ...
          <section id="optimering" className="scroll-mt-32 mb-12">
            <Card className="bg-white/80 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-2xl">
          ...
          {/* FAQ */}
          <section id="vanliga-frågor-faq" className="scroll-mt-32">
            <Card className="bg-white/80 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-2xl">
