...
const DashboardCard = ({
  ...
  onClick?: () => void;
  disabled?: boolean;
}) => <Card className={`p-6 transition-all duration-200 animate-slideIn ${disabled ? 'opacity-50 cursor-not-allowed' : 'hover:shadow-lg cursor-pointer hover:bg-indigo-50'}`} onClick={!disabled ? onClick : undefined}>
  ...
  return <AppLayout>
      <div className="max-w-7xl mx-auto">
        <header className="mb-8 bg-gradient-to-r from-indigo-50 to-purple-50 p-8 rounded-2xl">
          <h1 className="text-3xl font-bold text-indigo-900 mb-2">Välkommen till Vårdschema</h1>
